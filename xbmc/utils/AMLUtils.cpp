...
bool aml_mode_to_resolution(const char *mode, RESOLUTION_INFO *res)
{
  ...
  else if (StringUtils::EqualsNoCase(fromMode,"720p23.98hz")) // fake resolutions
  {
    res->iWidth = 1280;
    res->iHeight= 720;
    res->iScreenWidth = 1280;
  ...
  else if (StringUtils::EqualsNoCase(fromMode,"720p25hz")) // fake resolution
  {
    res->iWidth = 1280;
    res->iHeight= 720;
    res->iScreenWidth = 1280;
  ...
  else if (StringUtils::EqualsNoCase(fromMode,"1080p23.98hz")) // fake resolution
  {
    res->iWidth = 1920;
    res->iHeight= 1080;
    res->iScreenWidth = 1920;
  ...
  else if (StringUtils::EqualsNoCase(fromMode,"1080p25hz")) // fake resolution
  {
    res->iWidth = 1920;
    res->iHeight= 1080;
    res->iScreenWidth = 1920;
